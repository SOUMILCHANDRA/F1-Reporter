...
- **Race Hub**: Dynamic telemetry charts visualizing lap-time performance across the field.
- **Tyre Strategy**: High-precision stint timelines with compound tracking.
- **Standings**: Position-colored rankings with points progression visualization.
- **Calendar**: Lights-out countdowns and sprint weekend tracking.
- **Responsive Design**: Seamlessly transitions between mobile and desktop layouts.
